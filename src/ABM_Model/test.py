    ...
    with torch.no_grad():
        ...
        for x, y in test:
            for xx in x:
                ...
                print(xx_pad.shape, params, beam_k, idx_decoder)
...
if __name__ == "__main__":
    ...
    main(args.k, args.model_path, args.dictionary_target, args.test_dataset, args.label, args.saveto, args.output,
         args.idx_decoder)
