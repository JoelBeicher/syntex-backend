...
class Encoder_Decoder(nn.Module):
    def __init__(self, params):
        ...
        self.encoder1 = DenseNet(growthRate=params['growthRate'], reduction=params['reduction'],
    ...
    def forward(self, params, x, x_mask, y, y_mask, y_reverse, y_mask_reverse, one_step=False):
        ...
        if params['L2R'] == 1:
            ...
            h2ts1, cts1, alphas1, _alpha_pasts = self.gru_model(params, emb1, y_mask, ctx1, ctx_mask, one_step,
                                                                init_state1, alpha_past=None)
        ...
        if params['R2L'] == 1:
            ...
            h2ts2, cts2, alphas2, _alpha_pasts = self.gru_model2(params, emb2, y_mask_reverse, ctx1, ctx_mask, one_step,
                                                                 init_state2, alpha_past=None)
    ...
    def f_next(self, params, y, y_mask, ctx, ctx_mask, init_state, alpha_past, one_step, idx_decoder=1):
        ...
        if idx_decoder == 1:
            ...
            next_state, cts, _alpha, next_alpha_past = self.gru_model(params, emb_beam, y_mask, ctx, ctx_mask, one_step,
                                                                      init_state, alpha_past)
            ...
            # one step of two gru layers
            next_state, cts, _alpha, next_alpha_past = self.gru_model2(params, emb_beam, y_mask, ctx, ctx_mask,
